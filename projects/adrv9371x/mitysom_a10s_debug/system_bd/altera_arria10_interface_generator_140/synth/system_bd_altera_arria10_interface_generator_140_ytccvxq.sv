...
module system_bd_altera_arria10_interface_generator_140_ytccvxq(
// hps_io
 ...
 ,inout wire [1 - 1 : 0 ] hps_io_gpio_gpio0_io9
);
...
assign hps_io_phery_i2c1_SDA = intermediate[28] ? '0 : 'z;
assign hps_io_phery_i2c1_SCL = intermediate[29] ? '0 : 'z;
assign hps_io_gpio_gpio0_io1 = intermediate[31] ? intermediate[30] : 'z;
assign hps_io_gpio_gpio0_io9 = intermediate[33] ? intermediate[32] : 'z;

wire [34 - 1 : 0] intermediate;

wire [24 - 1 : 0] floating;
