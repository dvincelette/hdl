...
source "$script_dir/system_bd_altera_emif_arch_nf_180_ewuzaei_report_timing_core.tcl"


if [ info exists ddr_db ] {
   unset ddr_db
}
system_bd_altera_emif_arch_nf_180_ewuzaei_initialize_ddr_db ddr_db var
...
foreach inst $instances {
   ...
   if {[llength $instances] <= 1} {
      set fbasename "${::GLOBAL_system_bd_altera_emif_arch_nf_180_ewuzaei_corename}"
   } else {
      set fbasename "${::GLOBAL_system_bd_altera_emif_arch_nf_180_ewuzaei_corename}_${inst_id}"
   }
   ...
   system_bd_altera_emif_arch_nf_180_ewuzaei_perform_read_capture_analysis $opcname $inst pins var summary
   
   #######################################
   # Write Analysis

   system_bd_altera_emif_arch_nf_180_ewuzaei_perform_write_launch_analysis $opcname $inst pins var summary

   #######################################
   # Address/command Analyses

   system_bd_altera_emif_arch_nf_180_ewuzaei_perform_ac_analysis  $opcname $inst pins var summary

   #######################################
   # DQS Gating Analysis

   system_bd_altera_emif_arch_nf_180_ewuzaei_perform_dqs_gating_analysis   $opcname $inst pins var summary

   #######################################
   # Write Levelling Analysis 
   
   system_bd_altera_emif_arch_nf_180_ewuzaei_perform_write_levelling_analysis $opcname $inst pins var summary

   #######################################
   # PHY Analyses
   
   system_bd_altera_emif_arch_nf_180_ewuzaei_perform_core_analysis $opcname $inst pins var summary

   #######################################
   # Print out the Summary Panel for this instance   

   set summary [lsort -command system_bd_altera_emif_arch_nf_180_ewuzaei_sort_proc $summary]
   ...
   puts $f "Core: ${::GLOBAL_system_bd_altera_emif_arch_nf_180_ewuzaei_corename} - Instance: $inst"
   puts $f "Path, Setup Margin, Hold Margin"

   
   post_message -type info "Core: ${::GLOBAL_system_bd_altera_emif_arch_nf_180_ewuzaei_corename} - Instance: $inst"
   ...
   foreach summary_line $summary {
      ...
      if {$su != "--"} {
         set su [ system_bd_altera_emif_arch_nf_180_ewuzaei_round_3dp $su]
      }
      if {$hold != "--"} {
         set hold [ system_bd_altera_emif_arch_nf_180_ewuzaei_round_3dp $hold]
      }
