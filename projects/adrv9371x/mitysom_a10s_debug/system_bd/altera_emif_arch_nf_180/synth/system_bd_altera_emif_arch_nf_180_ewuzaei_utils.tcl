...
proc system_bd_altera_emif_arch_nf_180_ewuzaei_index_in_collection { col j } {
   set i 0
...
proc system_bd_altera_emif_arch_nf_180_ewuzaei_get_clock_to_pin_name_mapping {} {
   set result [list]
   ...
   foreach_in_collection clock $clocks_collection {
      ...
      set first_index [system_bd_altera_emif_arch_nf_180_ewuzaei_index_in_collection $clock_target 0]
...
proc system_bd_altera_emif_arch_nf_180_ewuzaei_get_clock_name_from_pin_name { pin_name } {
   set table [system_bd_altera_emif_arch_nf_180_ewuzaei_get_clock_to_pin_name_mapping]
   foreach entry $table {
...
proc system_bd_altera_emif_arch_nf_180_ewuzaei_find_all_keepers { mystring } {
...
proc system_bd_altera_emif_arch_nf_180_ewuzaei_round_3dp { x } {
   return [expr { round($x * 1000) / 1000.0  } ]
}

proc system_bd_altera_emif_arch_nf_180_ewuzaei_get_current_timequest_report_folder {} {
...
proc system_bd_altera_emif_arch_nf_180_ewuzaei_get_timequest_name {hier_name} {
   set sta_name $hier_name
   return $sta_name
}

proc system_bd_altera_emif_arch_nf_180_ewuzaei_are_entity_names_on { } {
   return [set_project_mode -is_show_entity]
}

proc system_bd_altera_emif_arch_nf_180_ewuzaei_get_core_instance_list {corename} {
   ...
   if {$::io_only_analysis == 1}  {
      ...
      set full_instance_list [system_bd_altera_emif_arch_nf_180_ewuzaei_get_core_full_instance_list $corename]
      set instance_list [list]

      foreach inst $full_instance_list {
         set sta_name [system_bd_altera_emif_arch_nf_180_ewuzaei_get_timequest_name $inst]
...
proc system_bd_altera_emif_arch_nf_180_ewuzaei_get_or_add_generated_clock {args} {
   array set opts { /
      -name "" /
      -target "" /
      -source "" /
   ...
   set clock_name [system_bd_altera_emif_arch_nf_180_ewuzaei_get_clock_name_from_pin_name $opts(-target)]
   ...
   if {[string compare -nocase $clock_name ""] == 0} {
      ...
      if {[get_collection_size $nets] > 0} {
         ...
         set clock_name [system_bd_altera_emif_arch_nf_180_ewuzaei_get_clock_name_from_pin_name $pin_name]
...
proc system_bd_altera_emif_arch_nf_180_ewuzaei_get_core_full_instance_list {corename} {
...
proc system_bd_altera_emif_arch_nf_180_ewuzaei_traverse_fanin_up_to_depth { node_id match_command edge_type results_array_name depth} {
   ...
   for {set i 0} {$i != $number_of_fanin_edges} {incr i} {
      ...
      if {$match_command == "" || [eval $match_command $fanin_id] != 0} {
         ...
         system_bd_altera_emif_arch_nf_180_ewuzaei_traverse_fanin_up_to_depth $fanin_id $match_command $edge_type results [expr {$depth - 1}]
      }
   }
}

proc system_bd_altera_emif_arch_nf_180_ewuzaei_is_node_type_pin { node_id } {
...
proc system_bd_altera_emif_arch_nf_180_ewuzaei_get_pll_clock_name { clock_id } {
...
proc system_bd_altera_emif_arch_nf_180_ewuzaei_get_names_in_collection { col } {
   set res [list]
...
proc system_bd_altera_emif_arch_nf_180_ewuzaei_format_3dp { x } {
   return [format %.3f $x]
}

proc system_bd_altera_emif_arch_nf_180_ewuzaei_get_colours { x y } {
...
proc system_bd_altera_emif_arch_nf_180_ewuzaei_max_in_collection { col attribute } {
   set i 0
   set max 0
   foreach_in_collection path $col {
      if {$i == 0} {
...
proc system_bd_altera_emif_arch_nf_180_ewuzaei_min_in_collection { col attribute } {
   set i 0
   set min 0
   foreach_in_collection path $col {
      if {$i == 0} {
...
proc system_bd_altera_emif_arch_nf_180_ewuzaei_min_in_collection_to_clock { col attribute clock } {
   set i 0
   set min ERROR
   foreach_in_collection path $col {
...
proc system_bd_altera_emif_arch_nf_180_ewuzaei_min_in_collection_from_clock { col attribute clock } {
   set i 0
   set min ERROR
   foreach_in_collection path $col {
...
proc system_bd_altera_emif_arch_nf_180_ewuzaei_min_in_collection_to_name { col attribute name } {
   set i 0
   set min 0
   foreach_in_collection path $col {
...
proc system_bd_altera_emif_arch_nf_180_ewuzaei_min_in_collection_from_name { col attribute name } {
   set i 0
   set min 0
   foreach_in_collection path $col {
...
proc system_bd_altera_emif_arch_nf_180_ewuzaei_max_in_collection_to_name { col attribute name } {
   set i 0
   set max 0
   foreach_in_collection path $col {
      if {[get_node_info -name [get_path_info $path -to]] == $name} {
...
proc system_bd_altera_emif_arch_nf_180_ewuzaei_max_in_collection_from_name { col attribute name } {
   set i 0
   set max 0
   foreach_in_collection path $col {
      if {[get_node_info -name [get_path_info $path -from]] == $name} {
...
proc system_bd_altera_emif_arch_nf_180_ewuzaei_min_in_collection_to_name2 { col attribute name } {
   set i 0
   set min 0
   foreach_in_collection path $col {
...
proc system_bd_altera_emif_arch_nf_180_ewuzaei_min_in_collection_from_name2 { col attribute name } {
   set i 0
   set min 0
   foreach_in_collection path $col {
...
proc system_bd_altera_emif_arch_nf_180_ewuzaei_max_in_collection_to_name2 { col attribute name } {
   set i 0
   set max 0
   foreach_in_collection path $col {
      if {[regexp $name [get_node_info -name [get_path_info $path -to]]]} {
...
proc system_bd_altera_emif_arch_nf_180_ewuzaei_max_in_collection_from_name2 { col attribute name } {
   set i 0
   set max 0
   foreach_in_collection path $col {
      if {[regexp $name [get_node_info -name [get_path_info $path -from]]]} {
...
proc system_bd_altera_emif_arch_nf_180_ewuzaei_sort_proc {a b} {
   set idxs [list 1 2 0]
   foreach i $idxs {
      set ai [lindex $a $i]
      set bi [lindex $b $i]
...
proc system_bd_altera_emif_arch_nf_180_ewuzaei_gcd {p q} {
   set p [expr {abs($p)}]
   set q [expr {abs($q)}]
   while {$q != 0} {
      set r [expr {$p % $q}]
...
proc system_bd_altera_emif_arch_nf_180_ewuzaei_traverse_atom_path {atom_id atom_oport_id path} {
      ...
      if {[get_atom_node_info -key type -node $atom_id] == $atom_type} {
         if {$next_direction == "end"} {
            ...
            if {$atom_iport != -1} {
               ...
               set result [system_bd_altera_emif_arch_nf_180_ewuzaei_traverse_atom_path $source_atom $source_oterm [lrange $path 1 end]]
            } elseif {$atom_optional == "-optional"} {
               set result [system_bd_altera_emif_arch_nf_180_ewuzaei_traverse_atom_path $atom_id $atom_oport_id [lrange $path 1 end]]
            }
            ...
            if {$atom_oport != -1} {
               ...
               foreach dest $oport_fanout {
                  ...
                  set fanout_result_list [system_bd_altera_emif_arch_nf_180_ewuzaei_traverse_atom_path $dest_atom -1 [lrange $path 1 end]]
...
proc system_bd_altera_emif_arch_nf_180_ewuzaei_get_operating_conditions_number {} {
